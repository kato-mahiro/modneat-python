...
from modneat.attributes import FloatAttribute
from modneat.genes import BaseGene, DefaultConnectionGene
from modneat.genome import DefaultGenomeConfig, DefaultGenome
